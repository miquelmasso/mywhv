...
class MapOSMClonePage extends StatefulWidget {
  const MapOSMClonePage({super.key});

  @override
  State<MapOSMClonePage> createState() => MapOSMClonePageState();
}
...
class MapOSMClonePageState extends State<MapOSMClonePage>
  ...
  void _scheduleAdjacentZoomPrefetch() {
    if (!_isHospitality || !_mapReady || _tileCache == null) return;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (_isLoadingData) const Center(child: CircularProgressIndicator()),
