...
class _MailSetupPageState extends State<MailSetupPage> {
  ...
  Future<void> _pickAndSaveCV() async {
    // ✅ 1. Obrir el selector de fitxers
    ...
    try {
      // ✅ 3. Guardar sempre dins l'espai privat de l'app (sense permisos d'emmagatzematge global)
    ...
    return FutureBuilder<Map<String, String>>(
      ...
      builder: (context, snapshot) {
        ...
        return PopScope(
          ...
          child: Scaffold(
            appBar: AppBar(title: Text(t('profile.automatic_email'))),
            body: Padding(
                    ...
                    Column(
                      ...
                      children: [
                        FilledButton.icon(
                          ...
                          label: Text(t('mail.save_message')),
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: Text(
                            _cvPath != null
                                ? '${t('mail.current_cv')}: ${_cvPath!.split('/').last}'
                                : '${t('mail.current_cv')}: ${t('mail.no_cv')}',
                            style: const TextStyle(
                              fontSize: 14,
                              color: Colors.grey,
                            ),
