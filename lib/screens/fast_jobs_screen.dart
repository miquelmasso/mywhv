...
class FastJobsScreen extends StatelessWidget {
  ...
  static const List<_FastJobProvider> _providers = [
    _FastJobProvider(
      name: 'Uber Eats',
      logo: 'Uber Eats',
      imageAsset: 'assets/icons/uber eats icona.png',
    ...
    _FastJobProvider(
      name: 'Uber Drive',
      logo: 'Uber',
      imageAsset: 'assets/icons/Uber icona.jpg',
    ...
    _FastJobProvider(
      name: 'DoorDash',
      logo: 'DoorDash',
      imageAsset: 'assets/icons/DoorDash icona.png',
    ...
    _FastJobProvider(
      name: 'GoGet',
      logo: 'GoGet',
      imageAsset: 'assets/icons/GoGet icona.jpg',
