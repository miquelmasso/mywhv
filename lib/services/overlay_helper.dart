...
class OverlayHelper {
  ...
  // 1️⃣ showCopiedOverlay → Mostra un missatge temporal “copiat”.
  // 2️⃣ generateClusterMarkers → Agrupa marcadors (clustering).
  // 3️⃣ createBlackCircleIcon → Crea un cercle negre simple.
  // 4️⃣ createWorkCountMarker → Crea marcador amb número de treballadors.
  //
  // ------------------------------------------------------------
  ...
  // ---------- 🔹 Agrupació de marcadors (Clustering) ----------
