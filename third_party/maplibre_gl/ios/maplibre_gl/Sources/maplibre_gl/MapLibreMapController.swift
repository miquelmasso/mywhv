    ...
    UIGestureRecognizerDelegate
{
    ...
    func mapViewWillStartLoadingMap(_ mapView: MLNMapView) {
        NSLog("MapLibreMapController - mapViewWillStartLoadingMap center=(\(mapView.centerCoordinate.latitude), \(mapView.centerCoordinate.longitude)) zoom=\(mapView.zoomLevel)")
    }

    func mapViewDidFinishLoadingMap(_ mapView: MLNMapView) {
        NSLog("MapLibreMapController - mapViewDidFinishLoadingMap styleURL=\(String(describing: mapView.styleURL?.absoluteString))")
    }

    func mapViewDidFailLoadingMap(_ mapView: MLNMapView, withError error: Error) {
        NSLog("MapLibreMapController - mapViewDidFailLoadingMap error=\(error.localizedDescription) styleURL=\(String(describing: mapView.styleURL?.absoluteString))")
    }

    func mapView(_ mapView: MLNMapView, didFinishLoading _: MLNStyle) {
        NSLog("MapLibreMapController - didFinishLoading styleURL=\(String(describing: mapView.styleURL?.absoluteString))")
        isMapReady = true
    ...
    func mapViewDidFinishRenderingMap(_ mapView: MLNMapView, fullyRendered: Bool) {
        NSLog("MapLibreMapController - mapViewDidFinishRenderingMap fullyRendered=\(fullyRendered) center=(\(mapView.centerCoordinate.latitude), \(mapView.centerCoordinate.longitude)) zoom=\(mapView.zoomLevel)")
    }
